...
MOCK_FORENSIC_OPTIONS_DATA = pd.DataFrame([
    ...
    {'time': pd.to_datetime('2024-01-02', utc=True), 'symbol': 'SPOTC100', 'type': 'CALL', 'strike': 100.0, 'expiry_date': '2024-01-03', 'close': 2.50, 'high': 2.60, 'low': 2.40},
    # Put to be sold (expires next day)
    {'time': pd.to_datetime('2024-01-02', utc=True), 'symbol': 'SPOTP100', 'type': 'PUT', 'strike': 100.0, 'expiry_date': '2024-01-03', 'close': 2.00, 'high': 2.10, 'low': 1.90},
    ...
    {'time': pd.to_datetime('2024-01-03', utc=True), 'symbol': 'SPOTC100', 'type': 'CALL', 'strike': 100.0, 'expiry_date': '2024-01-03', 'close': 2.00, 'high': 2.10, 'low': 1.95}, # Sell executed at 1.95
    {'time': pd.to_datetime('2024-01-03', utc=True), 'symbol': 'SPOTP100', 'type': 'PUT', 'strike': 100.0, 'expiry_date': '2024-01-03', 'close': 0.00, 'high': 0.10, 'low': 0.00},  # Sell executed at 0.00

    # --- Day 3 (2024-01-04): Decision to buy a new call ---
    {'time': pd.to_datetime('2024-01-04', utc=True), 'symbol': 'SPOTC105', 'type': 'CALL', 'strike': 105.0, 'expiry_date': '2024-02-15', 'close': 3.00, 'high': 3.10, 'low': 2.90},
